...
<div id="qr" class="min-h-screen flex items-center justify-center bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
    <div id="login">
        ...
        <div>
            <form on:submit|preventDefault={fetchAndDisplayQR} class="mt-8 space-y-6" method="get">
                <div>
                    <label class="sr-only">Password</label>
                    <input type="password" autocomplete="password" bind:value={password} name="pswd" required 
